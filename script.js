...
function updatePopup(){
  ...
  if(syncVideo.ended){
    popupType = 'end'
    popupText.textContent = "Thank you for finishing this lecture! \r\n \r\n Your completion code is \"TypeEnd$\". Return to the survey, copy and paste the completion code in the text box to move on to the next step!"
...
function handlePopupButton(){
  ...
  if(popupType == 'switch'){
    ...
    taskWindow.location.href = 'https://ubc.ca1.qualtrics.com/jfe/form/SV_eVdVT25WiVg2J14';
  }
  if(popupType == 'end'){
    popupContainer.style.display = "none"
